...
const Arrow: FC<ArrowProps> = ({ fill = '#3B434E', down }) => {
	return (
		<span className={cn(styles.arrow, { [styles.down]: down })}>
			<svg width='6' height='10' viewBox='0 0 6 10' fill={fill} xmlns='http://www.w3.org/2000/svg'>
